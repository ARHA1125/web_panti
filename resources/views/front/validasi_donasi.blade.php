...
<section id="rekening" class="my-5">
    <div class="container" data-aos="fade-up">
        <header class="section-header mb-5">
            <p class="fs-2 fw-bold text-center" style="color: #2a4d69;">Informasi Rekening & QR Code Donasi</p>
        </header>
        ...
        <div class="row g-4">
            ...
            <!-- Kolom Kanan: QR Code -->
            <div class="col-md-7 d-flex flex-wrap justify-content-center align-items-start gap-4">
                <div class="qr-card text-center">
                    <h6 class="mb-3 text-primary fw-bold">QR Code</h6>
                    <img src="{{ asset('asset/img/qrcode.pn') }}" class="img-fluid" style="max-width: 250px;" alt="QR Panti">
                </div>
                <div class="qr-card text-center">
                    <h6 class="mb-3 text-success fw-bold">QR Code</h6>
                    <img src="{{ asset('asset/img/qrcode.pn') }}" class="img-fluid" style="max-width: 250px;" alt="QR Masjid">
                </div>
            </div>
        </div>
