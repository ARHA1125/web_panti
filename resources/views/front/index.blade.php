...
<section id='bnnr2' class="info-section position-relative" style="background: url('{{ asset('asset/img/bnnr18.jpg') }}') center center / cover no-repeat; height: 100vh; color: white;">
    <div class="overlay" style="position:absolute; top:0; left:0; right:0; bottom:0; background-color: rgba(0,0,0,0.6); z-index:1;"></div>
